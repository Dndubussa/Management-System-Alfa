-- Test MRN generation logic
-- This script simulates the MRN generation process

-- Check current patients and their MRNs
SELECT 
  id,
  mrn,
  first_name,
...
-- Test the MRN generation logic
-- This simulates what happens when a new patient is created
