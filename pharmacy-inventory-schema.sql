-- Pharmacy Inventory Management Schema for Alfa Specialized Hospital
-- This file creates the complete pharmacy inventory tracking system
...
create table medication_transactions (
  id uuid default uuid_generate_v4() primary key,
...
create index idx_medication_inventory_batch on medication_inventory(batch_number);
...
create index idx_medication_transactions_medication on medication_transactions(medication_inventory_id);
create index idx_medication_transactions_type on medication_transactions(transaction_type);
create index idx_medication_transactions_prescription on medication_transactions(prescription_id);
...
-- Sample medication inventory with batch tracking
...
-- Sample medication transactions
