-- ICD-10/ICD-11 Standardized Health Terminologies Schema
...
CREATE TABLE IF NOT EXISTS public.medical_record_diagnoses (
    ...
    icd10_code VARCHAR(10) REFERENCES public.icd10_codes(code),
    icd11_code VARCHAR(20) REFERENCES public.icd11_codes(code),
...
CREATE TABLE IF NOT EXISTS public.service_code_mappings (
    ...
    icd10_code VARCHAR(10) REFERENCES public.icd10_codes(code),
    icd11_code VARCHAR(20) REFERENCES public.icd11_codes(code),
    cpt4_code VARCHAR(10) REFERENCES public.cpt4_codes(code),
    sha_code VARCHAR(20) REFERENCES public.tanzania_service_codes(sha_code),
...
-- Insert sample ICD-10 codes (common conditions in Tanzania)
...
-- Insert sample ICD-11 codes (common conditions)
...
-- Insert sample CPT-4 procedure codes
...
-- Insert sample Tanzania service codes (SHA codes for NHIF)
...
JOIN public.service_prices sp ON scm.service_price_id = sp.id
